...
function UserManagementScreen({navigation}) {
    ...
    useEffect(() => {
      ...
      const handleSearch = (text) => {
        ...
        const filteredUsers = unfilteredUserData.filter((user) => (
                    ...
                    {selectedUser && (
                        <>
                            <View style={{ width: dimensions.width < 768 ? '100%' : '45%' }}>
                                <Text style={{ fontSize: 20, fontWeight: 400, marginVertical: 8, textAlign: 'left', alignItems: 'flex-start' }}>Name</Text>
                                <View style={{
                                height: 48,
                                borderColor: '#FEF0E6',
                                borderWidth: 1,
                            ...
                            <View style={{ width: dimensions.width < 768 ? '100%' : '45%' }}>
                                <Text style={{ fontSize: 20, fontWeight: 400, marginVertical: 8, textAlign: 'left', alignItems: 'flex-start' }}>E-mail</Text>
                                <View style={{
                                height: 48,
                                borderColor: '#FEF0E6',
                                borderWidth: 1,
                            ...
                            <View style={{ width: dimensions.width < 768 ? '100%' : '45%' }}>
                                <Text style={{ fontSize: 20, fontWeight: 400, marginVertical: 8, textAlign: 'left', alignItems: 'flex-start' }}>Role</Text>
                                <View style={{
                                height: 48,
                                borderColor: '#FEF0E6',
                                borderWidth: 1,
