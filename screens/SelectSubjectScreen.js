...
import { View, Text, StyleSheet, TouchableOpacity, Picker, Dimensions, Image } from 'react-native';
...
const SelectSubjectScreen = ({ navigation }) => {
  ...
  const subjectsByYear = {
    '4': [
      { id: '1766603', name: 'Family medicine clerkship' }
    ],
    '5': [
      { id: '17666007', name: 'Internal medicine clerkship' },
      { id: '17666008', name: 'Surgery clerkship' },
      { id: '17666009', name: 'Anesthesiology, cardiology and critical care medicine clerkship' },
    ...
    '6': [
      ...
      { id: '17676006', name: 'Practicum in orthopedics and emergency medicine' }
    ]
  };

  const handleSubjectSelection = () => {
    const selectedSubjectData = subjectsByYear[selectedYear].find(subject => subject.id === selectedSubject);
